...
/// where it is provided as the [Scaffold.CustomBottomNavigationBar] argument.
///
...
class CustomBottomNavigationBar extends StatefulWidget {
  ...
  /// is provided as the [Scaffold.CustomBottomNavigationBar] argument.
  ///
  ...
  CustomBottomNavigationBar({
    ...
    this.iconSize: 24.0,
        ...
        type = type ?? (items.length <= 3 ? CustomBottomNavigationBarType.fixed : CustomBottomNavigationBarType.shifting),
        super(key: key);
  ...
  @override
  _CustomBottomNavigationBarState createState() => new _CustomBottomNavigationBarState();
}
    ...
    switch (widget.type) {
      case CustomBottomNavigationBarType.fixed:
        ...
        for (int i = 0; i < widget.items.length; i += 1) {
          children.add(
            new _CustomBottomNavigationTile(
              widget.type,
              widget.items[i],
              _animations[i],
              widget.iconSize,
